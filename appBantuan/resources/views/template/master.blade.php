<!DOCTYPE html>
    ...
    <meta name="viewport" content="width=device-width, initialscale=1.0" />
        ...
        <script type="text/javascript" src="{{ asset('/lib/js/jquery.min.js')}}">
        </script>
 </head>
 ...
 <li>
 <a class="text-white" href="{{route('datapenduduk')}}">
 <i class="bi bi-book mr-2"></i>
 Data Penduduk
 </a>
 </li>
 <li>
 <a class="text-white" href="{{route('datasembako')}}">
...
onclick="menuSamping()">
 ...
 <script type="text/javascript" src="{{ asset('/lib/js/bootstrap.js')
}}"></script>
 <script type="text/javascript" src="{{ asset('/lib/js/datatables.min.js')
}}"></script>
